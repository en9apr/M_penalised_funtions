...
class Optimiser(object):
    ...
    def EMO(func, fargs=(), fkwargs={}, cfunc=None, cargs=(), ckwargs={},\
        ...
        while True:
            ...
            print("Plotting: r_new: ", r_new)
            print("Plotting: std_new: ", std_new)
            print('============================================================')
            ...
            ax1.fill_betweenx(np.array([-40, 30]), x_new[0]-r_new[0], x_new[0]+r_new[0], color="red", alpha=0.1)          
            ax1.set_xlabel('x')
            ax1.set_ylabel('f(x)')
            #ax1.fill_betweenx(np.array([-40, 30]), xopt1-mop.surr.radius, xopt1+mop.surr.radius, color="gray", alpha=0.25)
            ax1.set_ylim(-40, 30)
            ...
            ax3.fill_betweenx(np.array([-40, 30]), x_new[0]-r_new[0], x_new[0]+r_new[0], color="red", alpha=0.1)
            ...
            if(r_new < r_small):
                ...
                mop.surr.radius = r_new
                mop.surr.std_dev_inds = std_new
